...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { address: @workshop.address, description: @workshop.description, grade: @workshop.grade, images: @workshop.images, price: @workshop.price, title: @workshop.title } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { address: @workshop.address, description: @workshop.description, grade: @workshop.grade, images: @workshop.images, price: @workshop.price, title: @workshop.title } }
